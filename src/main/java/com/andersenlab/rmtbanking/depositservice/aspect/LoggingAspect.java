package com.andersenlab.rmtbanking.depositservice.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public *  com.andersenlab.rmtbanking.depositservice.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.andersenlab.rmtbanking.depositservice.service.*.*(..))")
